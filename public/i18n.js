...
const translations = {
  es: {
    ...
    "host.status.newSessionConfirm": "Crear una nueva sesion? Se conservara la conexion de Spotify, pero se reiniciaran jugadores y puntajes.",
    "host.status.newSessionCreated": "Nueva sesion creada",
    ...
    "player.hostPlaceholder": "Codigo de sala",
    "player.roomRequired": "Usa el enlace o QR de una sala para entrar.",
    "player.enter": "Entrar",
    "player.ready": "Listo",
    "player.hostLabel": "Host",
    ...
    "player.playlistSelector": "Cambiar playlist",
    "player.selectPlaylist": "Selecciona una playlist",
    "player.playlistUnavailable": "No hay playlists disponibles",
  ...
  en: {
    ...
    "host.status.newSessionConfirm": "Create a new session? Spotify will stay connected, but players and scores will reset.",
    "host.status.newSessionCreated": "New session created",
    ...
    "player.hostPlaceholder": "Room code",
    "player.roomRequired": "Use a room link or QR code to join.",
    "player.enter": "Enter",
    "player.ready": "Ready",
    "player.hostLabel": "Host",
    ...
    "player.playlistSelector": "Change playlist",
    "player.selectPlaylist": "Choose a playlist",
    "player.playlistUnavailable": "No playlists available",
    "player.clear": "Clear",
